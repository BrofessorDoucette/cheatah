...
> ⚠️ **Status: pre-alpha (v0.9.0-alpha).** cheatah runs and is heavily tested
...
|--------|------------------|
| **Lines** | 100.00% (2426/2426) |
| **Functions** | 100.00% (350/350) |
| Regions | 96.41% |
| Branches | 90.07% |
<!-- coverage:end -->
...
MIT — © 2026 Joshua Doucette; see [LICENSE](LICENSE).
