 ...
 * @note O(1); no heap (1-char small-string optimization).
 * @test CheatahBuiltins.LenOrdChr
 */
 ...
 * @return `"0x…"` (with sign).
 * @note O(log @p value); allocates the result string.
 ...
 * @note O(n); allocates a temporary `std::string` for the parse.
 * @test CheatahBuiltins.Conversions
 */
