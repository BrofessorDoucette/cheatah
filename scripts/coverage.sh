...
# (the in-process unit tests: cheatah_tests, which includes the linalg core + smoke).
#
...
cmake --build "$B" --target cheatah_tests >/tmp/cheatah_cov_build.log 2>&1 \
